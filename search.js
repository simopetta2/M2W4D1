...
function jobResearch() {
  let work = document.querySelector('#work').value.toLowerCase();
  let location = document.querySelector('#position').value.toLowerCase();
  ...
  for (let i = 0; i < jobs.length; i++) {
    let offers = jobs[i]
    let titleMinuscolo = offers.title.toLowerCase()
